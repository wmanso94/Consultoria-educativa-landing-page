        ...
        <section id="contacto" className="py-28 bg-gradient-to-br from-slate-950 via-slate-900 to-slate-800 relative overflow-hidden" ref={sectionRef}>
            ...
            <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
                <h2 className="reveal fade-up text-3xl md:text-5xl font-bold text-white mb-6 font-display leading-tight">
                    Deje la Capacitación en Manos de un{' '}
                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-accent-400 to-accent-500">Experto Senior</span>
                </h2>
                ...
                <div className="reveal fade-up delay-200 flex flex-col sm:flex-row justify-center gap-4">
                    <a
                        href="mailto:contacto@joseramonmanso.com?subject=Solicitud de Diagnóstico Gratuito"
                    ...
                    <a
                        href="https://wa.me/524491234567?text=Hola%2C%20me%20interesa%20saber%20más%20sobre%20sus%20servicios%20de%20consultoría%20educativa."
                        target="_blank"
