        ...
        <>
            ...
            <section className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 pt-20 pb-12 text-white relative overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
                    ...
                    <h1 className="text-4xl md:text-5xl font-bold mt-3 font-display">Trayectoria Profesional</h1>
                    <p className="text-xl text-slate-300 mt-4 max-w-2xl mx-auto">
                        Más de 40 años formando talento, dirigiendo instituciones educativas y transformando la educación.
                    </p>
                </div>
            </section>
